        ...
        <div className="container mx-auto max-w-4xl">
          <div className="space-y-8 animate-fade-in transition-transform duration-500 hover:-translate-y-1">
            ...
            <p className="text-lg text-foreground/90 leading-relaxed">
              Lumi & Co. was born from a passion for timeless beauty and exceptional craftsmanship.
              We believe that every woman deserves jewelry that not only adorns but empowers—pieces
            ...
            <p className="text-lg text-foreground/90 leading-relaxed">
              ...
              dedication into creating jewelry that transcends trends and celebrates individuality.
            </p>

            <p className="text-lg text-foreground/90 leading-relaxed">
              We source only the finest materials—rose gold that catches the light with warm radiance,
