...
-- Step 2: Backfill existing orders with sequential numbers (optional, only if you have existing orders)
-- This will assign numbers to existing orders that don't have them yet
DO $$
DECLARE
  rec RECORD;
  counter INT := 1000;
